...
<head>
    ...
    <style>
        :root {
            --primary-burgundy: #3D5A80; /* Steel Blue Primary */
            --primary-hover: #293E59;
            --bg-light-cream: #F2EFE7; /* Bright Beige Backdrop */
            --text-dark-mauve: #2D3748; /* Slate Text */
    ...
    <div class="login-container">
        ...
        <div class="login-sidebar hidden lg:flex">
            ...
            <div class="flex items-center space-x-3">
                <img src="{{ asset('images/logo.jpg') }}" class="w-10 h-10 object-contain border border-white/20" alt="Logo">
                <div>
                    <h2 class="text-sm font-bold tracking-wider uppercase text-white" style="font-family: var(--font-title);">SDN 28 KINALI</h2>
            ...
            <div class="my-auto max-w-lg">
                <span class="text-xs font-bold uppercase tracking-widest text-sky-300" style="font-family: var(--font-title);">Sistem Manajemen Sekolah</span>
                <h1 class="text-4xl font-extrabold text-white mt-2 mb-4 leading-tight" style="font-family: var(--font-title);">SIPRESMA 28</h1>
                <p class="text-white/80 leading-relaxed text-sm">Portal digital integrasi pencatatan nilai rapor siswa dan monitoring rekapitulasi prestasi secara transparan, aman, dan akuntabel di lingkungan SD Negeri 28 Kinali.</p>
            </div>
            ...
            <div class="login-card-custom">
                ...
                <div class="text-center mb-6 block lg:hidden">
                    <div class="inline-flex mb-3">
                        <img src="{{ asset('images/logo.jpg') }}" class="w-14 h-14 object-contain rounded-2xl shadow-sm border border-[#3D5A80]/20" alt="Logo">
                    </div>
                    <h1 class="text-xl font-bold tracking-tight text-slate-800" style="font-family: var(--font-title);">SIPRESMA 28</h1>
                    <p class="text-xs text-slate-500 mt-0.5">SD Negeri 28 Kinali</p>
                </div>

                <div class="mb-6">
                    <h2 class="text-2xl font-bold text-slate-800" style="font-family: var(--font-title);">Selamat Datang</h2>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center text-sm text-slate-600">
                            <input type="checkbox" name="remember" class="w-4 h-4 rounded bg-white border-slate-300 text-[var(--primary-burgundy)] focus:ring-[var(--primary-burgundy)]/20 transition">
                            <span class="ml-2">Ingat saya</span>
                        </label>
                        <a href="/" class="text-xs font-semibold text-slate-500 hover:text-slate-800 transition">Kembali ke Beranda</a>
                    </div>

                    <!-- Submit Button -->
                    <div class="pt-2">
                        <button type="submit"
                                style="background-color: var(--primary-burgundy) !important;"
