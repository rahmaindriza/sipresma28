        ...
        <form action="{{ route('admin.siswas.store') }}" method="POST" class="space-y-5">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" required class="w-full px-4 py-2.5 border border-[#D8E6F2] bg-white rounded-xl text-[#2D3748] focus:outline-none focus:border-[#3D5A80] transition text-sm" placeholder="Contoh: Ahmad Fajar">
                </div>
                <div class="col-md-6">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nis" value="{{ old('nis') }}" class="w-full px-4 py-2.5 border border-[#D8E6F2] bg-white rounded-xl text-[#2D3748] focus:outline-none focus:border-[#3D5A80] transition text-sm" placeholder="Contoh: 513">
                </div>
                <div class="col-md-6">
                    <label class="block text-xs font-semibold text-[#2D3748] uppercase tracking-wider mb-2">NISN (10 Karakter)</label>
                    <input type="text" name="nisn" value="{{ old('nisn') }}" required maxlength="10" minlength="10" class="w-full px-4 py-2.5 border border-[#D8E6F2] bg-white rounded-xl text-[#2D3748] focus:outline-none focus:border-[#3D5A80] transition text-sm" placeholder="Contoh: 0123456789">
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-12">
                    ...
                    <input type="text" name="nik" value="{{ old('nik') }}" required maxlength="16" minlength="16" class="w-full px-4 py-2.5 border border-[#D8E6F2] bg-white rounded-xl text-[#2D3748] focus:outline-none focus:border-[#3D5A80] transition text-sm" placeholder="Contoh: 130601xxxxxxxxxx">
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}" required class="w-full px-4 py-2.5 border border-[#D8E6F2] bg-white rounded-xl text-[#2D3748] focus:outline-none focus:border-[#3D5A80] transition text-sm" placeholder="Contoh: Padang">
                </div>
                <div class="col-md-6">
                    <label class="block text-xs font-semibold text-[#2D3748] uppercase tracking-wider mb-2">Tanggal Lahir</label>
                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" required class="w-full px-4 py-2.5 border border-[#D8E6F2] bg-white rounded-xl text-[#2D3748] focus:outline-none focus:border-[#3D5A80] transition text-sm">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="alamat" required rows="4" class="w-full px-4 py-2.5 border border-[#D8E6F2] bg-white rounded-xl text-[#2D3748] focus:outline-none focus:border-[#3D5A80] transition text-sm" placeholder="Contoh: Jl. Raya Kinali No. 28...">{{ old('alamat') }}</textarea>
            </div>
            ...
            <div class="flex justify-end space-x-3 pt-4 border-t border-[#D8E6F2]">
                ...
                <button type="submit" class="px-5 py-2.5 bg-[#3D5A80] hover:bg-[#293E59] text-white font-semibold rounded-xl text-xs transition shadow-sm">Simpan Data</button>
            </div>
        </form>
    </div>
</div>
