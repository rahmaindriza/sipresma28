    ...
    <div class="glass-panel p-4 rounded-2xl shadow-sm border border-[var(--border-light)]">
        <form action="{{ route('admin.prestasi.index') }}" method="GET" class="flex flex-col md:flex-row gap-3">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.prestasi.cetak_rekap', request()->all()) }}" target="_blank" class="w-full md:w-auto px-4 py-2 text-white font-semibold rounded-xl text-xs transition text-center flex items-center justify-center gap-1.5" style="background-color: #3D5A80 !important; border: none; color: white !important;">
