...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div class="glass-panel p-6 rounded-2xl flex items-center space-x-4">
            <div class="p-3 rounded-xl" style="background-color: rgba(61, 90, 128, 0.15); color: var(--primary-burgundy);">
    ...
    <div class="glass-panel p-5 rounded-2xl">
        <h4 class="text-sm font-bold text-white mb-4">Pintasan Manajemen Data</h4>
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <!-- Manage Users Card -->
            <a href="{{ route('admin.users') }}" class="group block p-4 bg-slate-950/40 hover:bg-slate-900 border border-slate-800 hover:border-[var(--primary-burgundy)] rounded-xl transition duration-300">
                <div class="flex justify-between items-start">
                    <span class="p-2 bg-purple-600/10 text-purple-400 rounded-lg group-hover:bg-purple-600 group-hover:text-white transition duration-300">
                ...
                <h5 class="text-white font-bold text-sm mt-3">Manajemen Pengguna</h5>
                <p class="text-xs text-slate-400 mt-1 leading-relaxed">Kelola dan aktifkan/nonaktifkan akun guru, wali kelas, dan kepsek.</p>
            </a>

            <!-- Manage Master Data Card -->
            <a href="{{ route('admin.gurus') }}" class="group block p-4 bg-slate-950/40 hover:bg-slate-900 border border-slate-800 hover:border-[var(--primary-burgundy)] rounded-xl transition duration-300">
                <div class="flex justify-between items-start">
                    <span class="p-2 bg-blue-600/10 text-blue-400 rounded-lg group-hover:bg-blue-600 group-hover:text-white transition duration-300">
                ...
                <h5 class="text-white font-bold text-sm mt-3">Data Akademik</h5>
                <p class="text-xs text-slate-400 mt-1 leading-relaxed">Input data siswa, guru pengajar, kelas, mapel, dan tahun ajaran.</p>
            </a>

            <!-- Manage Assignments Card -->
            <a href="{{ route('admin.assignments') }}" class="group block p-4 bg-slate-950/40 hover:bg-slate-900 border border-slate-800 hover:border-[var(--primary-burgundy)] rounded-xl transition duration-300">
                <div class="flex justify-between items-start">
                    <span class="p-2 bg-yellow-600/10 text-yellow-400 rounded-lg group-hover:bg-yellow-600 group-hover:text-white transition duration-300">
                ...
                <h5 class="text-white font-bold text-sm mt-3">Penugasan Guru</h5>
                <p class="text-xs text-slate-400 mt-1 leading-relaxed">Petakan guru mengajar mapel apa di kelas mana pada semester aktif.</p>
            </a>

            <!-- Manage achievements Card -->
            <a href="{{ route('admin.prestasis') }}" class="group block p-4 bg-slate-950/40 hover:bg-slate-900 border border-slate-800 hover:border-[var(--primary-burgundy)] rounded-xl transition duration-300">
                <div class="flex justify-between items-start">
                    <span class="p-2 bg-rose-600/10 text-rose-400 rounded-lg group-hover:bg-rose-600 group-hover:text-white transition duration-300">
                ...
                <h5 class="text-white font-bold text-sm mt-3">Prestasi Sekolah</h5>
                <p class="text-xs text-slate-400 mt-1 leading-relaxed">Catat dan pantau prestasi akademik/non-akademik siswa SDN 28 Kinali.</p>
            </a>
        </div>
    </div>
                    ...
                    @forelse($topPrestasi as $index => $tp)
                        <div class="p-3 rounded-xl border border-slate-800 bg-slate-950/40 flex items-center justify-between transition hover:shadow-sm">
                            <div class="flex items-center space-x-3">
                                <div class="w-8 h-8 rounded-full bg-[#EBF3FC] text-[#3D5A80] flex items-center justify-center font-bold text-xs">
                                    {{ $index + 1 }}
                                </div>
                                <div>
