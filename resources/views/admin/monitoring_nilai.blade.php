                    ...
                    @forelse($students as $siswa)
                        ...
                        <tr class="hover:bg-[var(--accent-table-hover)] transition duration-150">
                            ...
                            <td class="py-3.5 px-4 text-right">
                                <a href="{{ route('admin.nilai.print_siswa', $siswa->id) }}" target="_blank" class="inline-flex items-center px-2.5 py-1.5 bg-blue-50 hover:bg-blue-600 text-blue-600 hover:text-white border border-blue-200 hover:border-blue-500 font-bold rounded-lg transition text-[10px]">
